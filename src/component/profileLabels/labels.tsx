...
const ProfileSegments = () => {
  const [labels, setLabels] = useState<Label[]>([
    {
      id: '1',
      text: 'CTOs from AI-based SaaS platforms in the US with over 100 employees, skilled in leadership and communication',
      checked: true,
    },
    {
      id: '2',
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <h3 className={styles.profileHeading}>Profile Segments</h3>
        <button
